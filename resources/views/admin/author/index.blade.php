    ...
    <div class="container-fluid">
        ...
        <div class="my-2 px-1">
            <div class="row">
                <div class="col-6">
                    <div>
                        <a href="{{route('noisanxuat.create')}}" class="btn-primary btn-sm">
                                ...
                                <tr>
                                    ...
                                    {!! Form::open(['method'=>'DELETE', 'action'=>['Admin\AdminAuthorsController@destroy', $author->id]]) !!}
                                        <div class="action d-flex flex-row">
                                            <a href="{{route('noisanxuat.edit', $author->id)}}" class="btn-primary btn btn-sm mr-2"><i class="fas fa-edit"></i></a>
                                    ...
                                    <td><a href="{{route('noisanxuat.edit', $author->id)}}">{{$author->name}}</a></td>
