            ...
            <div class="cart-summary my-3">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <p>Product Cost = {{Cart::total()}} VND</p>
                        <p>Shipping cost = 0.00 VND</p>
                        <p><strong>Total cost = {{Cart::total()}} VND</strong></p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-light p-3 my-4">
                <form action="{{route('cart.checkout')}}" method="post">
                    ...
                    <script src="https://checkout.stripe.com/checkout.js" class="stripe-button"
                            ...
                            data-amount=""
                            data-name="Trang's Shop"
                            data-description="Trang's Shop payment"
                            data-locale="auto">
                    </script>
                </form>
            </div>
