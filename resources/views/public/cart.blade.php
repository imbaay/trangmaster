    ...
    <div class="container">
        <div class="card my-4">
            ...
            <div class="card-body">
                    ...
                    <tr class="border-bottom">
                      ...
                      <td>
                        <span class="quantity-input mr-2 mb-2 d-flex flex-row">
                            ...
                            <a href="{{route('cart.increment', ['id' => $item->rowId, 'qty' => $item->qty, 'dienthoai_id'=> $item->id])}}" class="cart-plus">+</a>
                        </span>
                      </td>
                ...
                <tbody>
                    <tr>
                        <td colspan="4"><a href="{{route('all-phones')}}" class="text-primary">Continue shopping</a></td>
                ...
                @else
                    <div class="alert alert-warning">No item found in cart. <a href="{{route('all-phones')}}"> Continue shopping</a></div>
                @endif
            </div>
        </div>
    </div>
